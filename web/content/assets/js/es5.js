...
if (!Object.defineProperty) {
  Object.defineProperty = function (object, property, descriptor) {
    ...
    if (typeof descriptor === 'object') {
      ...
      } else if (typeof descriptor.get === 'function') { object.__defineGetter__(property, descriptor.get) }
      if (typeof descriptor.set === 'function') { object.__defineSetter__(property, descriptor.set) }
    }
    return object
  }
}
...
if (!Object.defineProperties) {
  Object.defineProperties = function (object, properties) {
    for (const property in properties) {
      if (Object.prototype.hasOwnProperty.call(properties, property)) { Object.defineProperty(object, property, properties[property]) }
    }
    return object
  }
}
...
if (!Array.prototype.every) {
  Array.prototype.every = function (block /*, thisp */) {
    const thisp = arguments[1]
    for (let i = 0; i < this.length; i++) {
      if (!block.call(thisp, this[i])) { return false }
    }
    return true
  }
}
...
if (!Array.prototype.some) {
  Array.prototype.some = function (block /*, thisp */) {
    const thisp = arguments[1]
    for (let i = 0; i < this.length; i++) {
      if (block.call(thisp, this[i])) { return true }
    }
    return false
  }
}
