 ...
 */
  ...
  jQuery.support = (function () {
    ...
    jQuery(function () {
      let container; let div; let tds; let marginDiv
      const divReset = 'padding:0;margin:0;border:0;display:block;overflow:hidden;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;'
 ...
 */
  jQuery.event = {
    ...
    add: function (elem, types, handler, data, selector) {
      ...
      let tns; let type; let namespaces; let handleObj
      let handleObjIn; let handlers; let special
      let t = 0
    ...
    remove: function (elem, types, handler, selector, mappedTypes) {
      let tns; let type; let origType; let namespaces; let origCount
      let j; let events; let special; let eventType; let handleObj
      let t = 0
    ...
    trigger: function (event, data, elem, onlyHandlers) {
      let i; let cur; let old; let ontype; let special; let handle; let eventPath; let bubbleType
    ...
    dispatch: function (event) {
      ...
      let i; let j; let cur; let ret; let selMatch; let matched; let matches; let handleObj; let sel
 ...
 */
  (function (window, undefined) {
    ...
    const markFunction = function (fn, value) {
    ...
    setDocument = Sizzle.setDocument = function (doc) {
      ...
      if (support.getIdNotName) {
        ...
        Expr.filter.ID = function (id) {
          const attrId = id.replace(rbackslash, '')
 ...
 */
    ...
    Expr = Sizzle.selectors = {
      ...
      pseudos: {
        ...
        lang: markFunction(function (lang) {
          ...
          const rlang = new RegExp('^' + lang.replace(rsingleBackslash, '$1\\$2') + '(?:-|$)', 'i')
    ...
    function tokenize (selector, parseOnly) {
      ...
      const cached = tokenCache[expando][selector + ' ']
    ...
    compile = Sizzle.compile = function (selector, group /* Internal Use Only */) {
      ...
      let cached = compilerCache[expando][selector + ' ']
  ...
  function getAll (context, tag) {
    let elems; let elem
    let i = 0
    let found = typeof context.getElementsByTagName !== 'undefined'
  ...
  jQuery.extend({
    clone: function (elem, dataAndEvents, deepDataAndEvents) {
      let destElements; let srcElements; let node; let i; let clone
    ...
    clean: function (elems, context, fragment, scripts, selection) {
      let elem; let i; let j; let tmp; let tag; let wrap; let tbody
      const ret = []
      let safe = context === document && safeFragment
    ...
    cleanData: function (elems, /* internal */ acceptData) {
      let data; let id; let elem; let type
      let i = 0
      const internalKey = jQuery.expando
  ...
  let curCSS; let getStyles; let iframe
 ...
 */
  ...
  function ajaxConvert (s, response) {
    let conv; let conv2; let current; let tmp
    const converters = {}
    let i = 0
  ...
  function defaultPrefilter (elem, props, opts) {
    ...
    let index; let prop; let value; let length; let dataShow; let toggle; let tween; let hooks; let oldfire
    const anim = this
    const style = elem.style
    const orig = {}
    const handled = []
